...
import { Sun, Moon, Monitor, Phone } from 'lucide-react';
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] px-4 py-2 text-sm font-semibold hover:bg-[hsl(var(--primary)/0.9)] transition-colors"
            >
