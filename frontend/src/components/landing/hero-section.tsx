...
async function HeroCta() {
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center rounded-full bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] px-8 py-4 text-lg font-semibold shadow-lg hover:bg-[hsl(var(--primary)/0.9)] transition-colors"
    >
      {t('hero.cta')}
    </a>
  );
